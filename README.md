...
# 프로젝트 소개
데이터 베이스 텀 프로젝트에서 만든 CLI 프로그램을 웹으로 구현해 본 프로젝트입니다!<br/><br/>
웹 응용프로그래밍이라는 수업에서 JavaScript와 NodeJS를 배우고 있어서, 이를 이용하여 웹으로 만들었습니다.<br/>
NodeJS 사용에 초점을 두고 있어서, 프론트 부분은 HTML/CSS/JS를 이용하여 모바일 사이즈로 간략하게 구현하였습니다 ㅎㅎ
...
## 사용자
- **회원가입 및 로그인**: 사용자는 웹 애플리케이션에 회원가입하고 로그인할 수 있습니다.
...
사용자의 주문부터 배달 완료 그리고 리뷰 작성까지 순차적으로 시나리오를 서술해보겠습니다.</br>
</br>
